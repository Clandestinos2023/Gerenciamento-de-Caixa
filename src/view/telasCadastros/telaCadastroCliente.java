...
public class telaCadastroCliente extends javax.swing.JFrame {
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        Integer idade;
        String nome, contato, rg, codigo, tipoCliente = null;
        ...
        try {
            clicont.cadastrar(nome, idade, tipoCliente, codigo, contato);
        
            System.out.printf("%s, %d, %s, %s, %s", nome, idade, contato,
                    tipoCliente, codigo);
